        ...
        VStack(spacing: 30) {
            ...
            HStack {
                ...
                if !viewModel.isRunning {
                    CircularButton(color: .green, contentColor: .white, image: "play.fill") {
                        viewModel.start()
                    }
                } else {
                    CircularButton(color: .red, contentColor: .white, image: "pause.fill") {
                        viewModel.pause()
                    }
                }
            ...
            // HStack {
            //    TextField("Zeit (Sek)", text: $inputTime)
            //        .keyboardType(.numberPad)
            //        .textFieldStyle(.roundedBorder)
            //        .frame(width: 120)
            //
            //   Button("Setzen") {
            //      if let value = TimeInterval(inputTime) {
            //          viewModel.setTime(to: value)
            //      }
            //  }
