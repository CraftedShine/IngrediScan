...
class MockIngredients {
    ...
    public init(){
        ingredients = [Ingredient(id: 0, name: "Eier", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 3, name: "Tomaten", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 4, name: "Zwiebeln", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 5, name: "Knoblauch", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 6, name: "Garam ma Sala", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 7, name: "Salat", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 8, name: "Zucker", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 9, name: "Mehl", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 10, name: "Pfeffer", unitId: 1, imageUrl: "eier", unit: stk),Ingredient(id: 11, name: "Bananen", unitId: 1, imageUrl: "eier", unit: stk), Ingredient(id: 1, name: "Spaghetti", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g")), Ingredient(id: 2, name: "Speck", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g"))]
    }
}
...
extension Recipe {
        ...
        Recipe(
            ...
            usesIngredients: [
                UsesIngredient(
                    ...
                    amount: 250,
                    ingredientId: 1,
                    ingredient: Ingredient(id: 1, name: "Spaghetti", unitId: 1, imageUrl: "eier",
                ...
                UsesIngredient(
                    ...
                    amount: 100,
                    ingredientId: 2,
                    ingredient: Ingredient(id: 2, name: "Speck", unitId: 1, imageUrl: "eier",
                                           unit: Unit(id: 1, name: "g"))
    ...
    static var pizzaMargherita: Recipe {
        Recipe(
            ...
            usesIngredients: [
                UsesIngredient(id: 3, amount: 500, ingredientId: 3, ingredient: Ingredient(id: 3, name: "Mehl", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g"))),
                UsesIngredient(id: 4, amount: 300, ingredientId: 4, ingredient: Ingredient(id: 4, name: "Tomatensauce", unitId: 2, imageUrl: "eier", unit: Unit(id: 2, name: "ml"))),
                UsesIngredient(id: 5, amount: 125, ingredientId: 5, ingredient: Ingredient(id: 5, name: "Mozzarella", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g")))
            ],
            hasSteps: [
    ...
    static var caesarSalad: Recipe {
        Recipe(
            ...
            usesIngredients: [
                UsesIngredient(id: 6, amount: 200, ingredientId: 6, ingredient: Ingredient(id: 6, name: "Römersalat", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g"))),
                UsesIngredient(id: 7, amount: 50, ingredientId: 7, ingredient: Ingredient(id: 7, name: "Croutons", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g"))),
                UsesIngredient(id: 8, amount: 30, ingredientId: 8, ingredient: Ingredient(id: 8, name: "Parmesan", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g")))
            ],
            hasSteps: [
    ...
    static var cheesecake: Recipe {
        Recipe(
            ...
            usesIngredients: [
                UsesIngredient(id: 9, amount: 500, ingredientId: 9, ingredient: Ingredient(id: 9, name: "Quark", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g"))),
                UsesIngredient(id: 10, amount: 200, ingredientId: 10, ingredient: Ingredient(id: 10, name: "Zucker", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "g"))),
                UsesIngredient(id: 11, amount: 3, ingredientId: 11, ingredient: Ingredient(id: 11, name: "Eier", unitId: 3, imageUrl: "eier", unit: Unit(id: 3, name: "Stück")))
            ],
            hasSteps: [
