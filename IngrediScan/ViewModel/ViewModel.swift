...
class ViewModel: ObservableObject {
    ...
    init() {
        ...
        ingredients = [Ingredient(id: 9, name: "Quark", unitId: 2, imageUrl: "eier", unit: Unit(id: 2, name: "g")), Ingredient(id: 10, name: "Zucker", unitId: 2, imageUrl: "eier", unit: Unit(id: 2, name: "g")), Ingredient(id: 11, name: "Eier", unitId: 1, imageUrl: "eier", unit: Unit(id: 1, name: "Stk"))]
#else
        Task {
            await loadRecipes()
        }
